function gen_name=model(expression_tumor_fileName,expression_normal_fileName,path,N,MaxFE,experiment_num)
%% *************************tumor data****************************
...
for fnum = 1:length(numf)-2 % all patient samples
    ...
    label=b.m;
    [PF,PS,Non_dominated_sol]=CMMONCT_EA(adjacent,N,MaxFE,experiment_num,label);
